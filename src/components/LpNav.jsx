...
const LpNav = () => {
  ...
  return (
    <nav className="nav bg-transparent flex lg:justify-between lg:items-center py-4 px-6">
  ...
  <ul className='lp-booking-nav-ul-2 lg:flex items-center'>
    ...
    <li className='header-signup-btn font-semibold bg-white p-2 rounded-lg cursor-pointer' onClick={()=>navigate("/signup")} >Sign up</li>
  </ul>
  </nav>
  )
